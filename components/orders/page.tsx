...
export default function OrdersPage() {
  ...
  const [orderMode, setOrderMode] = useState<"DQ" | "i5Q">("DQ");
  ...
  try {
    const res = await fetch("/api/orders/create", {
      ...
      body: JSON.stringify({
        ...
        ...(isI5qDqBase(selectedBaseName) ? { orderMode } : {}),
...
>
  ...
  <button
    ...
    onClick={() => {
      setSavedOrder(null);
      if (isI5qDqBase(selectedBaseName)) {
        setOrderMode("DQ");
      }
      setOrderItems([]);
